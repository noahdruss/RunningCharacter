...
window.onload = function init() {
    ...
    gl.uniform1i(visibleStateLoc, 1);
    ...
    loadImages(document.getElementById("texture1"), document.getElementById("texture2"));
    columnTextures = [stripedTexture, wallpaperTexture];
...
function loadImages(texImage1, texImage2) {
...
function initSceneNodes(Id) {
    ...
    switch (Id) {
        ...
        case columnId1:
            ...
            scene[columnId1] = createNode(m, column, columnId2, null, brown, grayish, 0, null);
            break;

        case columnId2:
            m = translate(colPosArray[columnId2]);
            scene[columnId2] = createNode(m, column, columnId3, null, brown, grayish, 1, null);
            break;
        ...
        case columnId4:
            ...
            scene[columnId4] = createNode(m, column, columnId5, null, brown, grayish, 0, null);
            break;

        case columnId5:
            m = translate(colPosArray[columnId5]);
            scene[columnId5] = createNode(m, column, columnId6, null, brown, grayish, 1, null);
            break;
        ...
        case columnId7:
            ...
            scene[columnId7] = createNode(m, column, columnId8, null, brown, grayish, 0, null);
            break;

        case columnId8:
            m = translate(colPosArray[columnId8]);
            scene[columnId8] = createNode(m, column, columnId9, null, brown, grayish, 1, null);
            break;
        ...
        case columnId10:
            ...
            scene[columnId10] = createNode(m, column, sphereId1, null, brown, grayish, 0, null);
            break;

        case sphereId1:
            m = translate(spherePosArray[sphereId1]);
            scene[sphereId1] = createNode(m, sphere, sphereId2, null, red, null, null, null);
            break;

        case sphereId2:
            m = translate(spherePosArray[sphereId2]);
            scene[sphereId2] = createNode(m, sphere, sphereId3, null, yellow, null, null, null);
            break;
        ...
        case sphereId4:
            ...
            scene[sphereId4] = createNode(m, sphere, sphereId5, null, lightblue, null, null, null);
            break;
        ...
        case sphereId6:
            ...
            scene[sphereId6] = createNode(m, sphere, sphereId7, null, darkblue, null, null, null);
            break;
        ...
        case sphereId8:
            ...
            scene[sphereId8] = createNode(m, sphere, sphereId9, null, darkcyan, null, null, null);
            break;
        ...
        case sphereId10:
            ...
            scene[sphereId10] = createNode(m, sphere, null, null, black, null, null, null);
            break;
    }
}
...
function setDrawState(color, texIndex) {
    if (inShadow) {
        ...
        if (texIndex != null) {
            gl.activeTexture(gl.TEXTURE2);
            gl.bindTexture(gl.TEXTURE_2D, columnTextures[texIndex]);
            gl.uniform1i(textureLoc, 2);
